...
class BasicGAN(nn.Module):
    ...
    def save_model(self, epoch):
        ...
        torch.save(self.G.state_dict(),
                   os.path.join(self.model_checkpoint_dir, '{}_G_epoch_{}.pth'.format(self.cfg.PROJECT_NAME, epoch)))
        torch.save(self.D.state_dict(),
                   os.path.join(self.model_checkpoint_dir, '{}_D_epoch_{}.pth'.format(self.cfg.PROJECT_NAME, epoch)))
    ...
    def walking_latent_space(self):
        ...
        self.logger.log(
            'Walking latent space done, save to {}'.format(os.path.join(self.log_dir, 'walking_latent_space.gif')))
