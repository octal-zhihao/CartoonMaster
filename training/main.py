...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="EBGAN", help="Name of the model to train")
    parser.add_argument("--is_unrolled", type=bool, default=False, help="Whether to use unrolled GANs")
    parser.add_argument("--unrolled_steps", type=int, default=5, help="Number of unrolled steps for unrolled GANs")
    parser.add_argument("--mode", type=str, default="train", help="Mode to run the script in: train or predict")
    parser.add_argument("--checkpoint_path", type=str, default="my_checkpoint/epoch=769-step=24640.ckpt", help="Path to the model checkpoint for predictions")
    ...
    if args.mode == "predict":
        ...
        if args.model_name == "EBGAN":
            EBGAN_generator(model, args.latent_dim, save_dir="generated_images")
        elif args.model_name == "DCGAN":
            DCGAN_generator(model, args.latent_dim, save_dir="generated_images")
        else:
